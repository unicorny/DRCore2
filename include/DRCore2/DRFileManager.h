...
struct DRCORE2_EXPORT DRSHauptHeader
{
...
struct DRCORE2_EXPORT DRSBlockHeaderF
{
    u16         u16HeaderLength;
    u32         u32BlockLength;
    DHASH	ID;
...
struct DRCORE2_EXPORT DRSBlockHeader
{
    int         iBlockSize;
...
//----------------------------------------------------------------------------------------------------------------------
//Hauptheader
struct DRCORE2_EXPORT DRSMasterHeader
{
...
class DRCORE2_EXPORT DRFileManager
{
public:
